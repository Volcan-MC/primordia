package nebula.primordia.screen.custom;
...
public class ForgeScreen extends HandledScreen<ForgeScreenHandler> {
    ...
    // note to volcan from infinity
    // USE SHIFT-WINDOWSKEY-CTRL-F9 TO HOTSWAP AND ADD CHANGES TO VARIBLES WITHOUT RESTARTING MC WHEN MAKING THE GUI
}